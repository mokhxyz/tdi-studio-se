...
public class WSDeleteCustomForm  implements java.io.Serializable {
    ...
    /**
     * Gets the wsCustomFormPK value for this WSDeleteCustomForm.
     * 
    ...
    /**
     * Sets the wsCustomFormPK value for this WSDeleteCustomForm.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSDeleteCustomForm)) return false;
        WSDeleteCustomForm other = (WSDeleteCustomForm) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSDeleteCustomForm.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSDeleteCustomForm"));
