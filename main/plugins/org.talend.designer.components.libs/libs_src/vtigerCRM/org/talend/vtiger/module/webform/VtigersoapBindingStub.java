...
public class VtigersoapBindingStub extends org.apache.axis.client.Stub implements org.talend.vtiger.module.webform.VtigersoapPortType {
    ...
    private org.apache.axis.description.OperationDesc [] _operations = new org.apache.axis.description.OperationDesc[3];
    ...
    private void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("create_contact_from_webform");
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("unsubscribe_email");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "email_address"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
    ...
    public java.lang.String create_lead_from_webform(java.lang.String lastname, java.lang.String email, java.lang.String phone, java.lang.String company, java.lang.String country, java.lang.String description, java.lang.String assigned_user_id) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://www.vtiger.com/vtigercrm/", "create_lead_from_webform"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {lastname, email, phone, company, country, description, assigned_user_id});
  ...
  throw axisFaultException;
    ...
    public java.lang.String create_contact_from_webform(java.lang.String first_name, java.lang.String last_name, java.lang.String email_address, java.lang.String home_phone, java.lang.String department, java.lang.String description, java.lang.String assigned_user_id) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://" + serverAddr + "/vtigerservice.php/create_contact_from_webform");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.vtiger.com/vtigercrm/", "create_contact_from_webform"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {first_name, last_name, email_address, home_phone, department, description, assigned_user_id});
  ...
  throw axisFaultException;
    ...
    public java.lang.String unsubscribe_email(java.lang.String email_address) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://" + serverAddr + "/vtigerservice.php/unsubscribe_email");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.vtiger.com/vtigercrm/", "unsubscribe_email"));
