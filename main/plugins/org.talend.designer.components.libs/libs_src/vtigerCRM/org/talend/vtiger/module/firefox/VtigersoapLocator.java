...
public class VtigersoapLocator extends org.apache.axis.client.Service implements org.talend.vtiger.module.firefox.Vtigersoap {
    ...
    public VtigersoapLocator(String serverAddr, String port) {
    	...
    	this.port = port;
    	this.vtigersoapPort_address = "http://" + serverAddr + ":" + port + "/vtigerservice.php";
    }
    ...
    public org.talend.vtiger.module.firefox.VtigersoapPortType getvtigersoapPort() throws javax.xml.rpc.ServiceException {
    ...
    public org.talend.vtiger.module.firefox.VtigersoapPortType getvtigersoapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.talend.vtiger.module.firefox.VtigersoapBindingStub _stub = new org.talend.vtiger.module.firefox.VtigersoapBindingStub(portAddress, this, serverAddr);
    ...
    public void setvtigersoapPortEndpointAddress(String serverAddr, String port) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.talend.vtiger.module.firefox.VtigersoapPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.talend.vtiger.module.firefox.VtigersoapBindingStub _stub = new org.talend.vtiger.module.firefox.VtigersoapBindingStub(new java.net.URL(vtigersoapPort_address), this, serverAddr);
                _stub.setPortName(getvtigersoapPortWSDDServiceName());
                return _stub;
            }
        }
