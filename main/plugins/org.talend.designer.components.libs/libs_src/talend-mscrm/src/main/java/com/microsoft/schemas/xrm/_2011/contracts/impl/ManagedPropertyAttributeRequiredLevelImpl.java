 ...
 */
public class ManagedPropertyAttributeRequiredLevelImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.xrm._2011.contracts.ManagedPropertyAttributeRequiredLevel
{
    private static final long serialVersionUID = 1L;
    
    public ManagedPropertyAttributeRequiredLevelImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.microsoft.schemas.xrm._2011.metadata.AttributeRequiredLevel.Enum getValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.microsoft.schemas.xrm._2011.metadata.AttributeRequiredLevel xgetValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.xrm._2011.metadata.AttributeRequiredLevel target = null;
            target = (com.microsoft.schemas.xrm._2011.metadata.AttributeRequiredLevel)get_store().find_element_user(VALUE$4, 0);
            return target;
        }
    }
     ...
     */
    public void setValue(com.microsoft.schemas.xrm._2011.metadata.AttributeRequiredLevel.Enum value)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetValue(com.microsoft.schemas.xrm._2011.metadata.AttributeRequiredLevel value)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.xrm._2011.metadata.AttributeRequiredLevel)get_store().add_element_user(VALUE$4);
            }
            target.set(value);
        }
    }
