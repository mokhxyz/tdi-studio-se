 ...
 */
public class AssociateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument
{
    private static final long serialVersionUID = 1L;
    
    public AssociateDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ASSOCIATE$0 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/xrm/2011/Contracts/Services", "Associate");
    
    
    /**
     * Gets the "Associate" element
     */
    public com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument.Associate getAssociate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument.Associate target = null;
            target = (com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument.Associate)get_store().find_element_user(ASSOCIATE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAssociate(com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument.Associate associate)
    {
        generatedSetterHelperImpl(associate, ASSOCIATE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "Associate" element
     */
    public com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument.Associate addNewAssociate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument.Associate target = null;
            target = (com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument.Associate)get_store().add_element_user(ASSOCIATE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class AssociateImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.xrm._2011.contracts.services.AssociateDocument.Associate
    {
        private static final long serialVersionUID = 1L;
