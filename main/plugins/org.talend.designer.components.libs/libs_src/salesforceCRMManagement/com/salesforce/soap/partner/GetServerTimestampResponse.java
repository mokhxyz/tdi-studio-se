...
public class GetServerTimestampResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "getServerTimestampResponse", "ns1");

    /**
     * field for Result
     */

    protected com.salesforce.soap.partner.GetServerTimestampResult localResult;

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.GetServerTimestampResult
     */
    public com.salesforce.soap.partner.GetServerTimestampResult getResult() {
        return localResult;
    }
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.GetServerTimestampResult param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":getServerTimestampResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getServerTimestampResponse",
                        xmlWriter);
            }
        ...
        public static GetServerTimestampResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getServerTimestampResponse".equals(type)) {
                            ...
                            return (GetServerTimestampResponse) com.salesforce.soap.partner.sobject.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setResult(com.salesforce.soap.partner.GetServerTimestampResult.Factory.parse(reader));
