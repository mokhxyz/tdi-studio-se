...
/**
 * DescribeThemeResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeThemeResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeThemeResponse", "ns1");

    /**
     * field for Result
     */

    protected com.salesforce.soap.partner.DescribeThemeResult localResult;
     ...
     */
    public com.salesforce.soap.partner.DescribeThemeResult getResult() {
        return localResult;
    }
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.DescribeThemeResult param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeThemeResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeThemeResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeThemeResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeThemeResponse object = new DescribeThemeResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeThemeResponse".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeThemeResponse) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    object.setResult(com.salesforce.soap.partner.DescribeThemeResult.Factory.parse(reader));
