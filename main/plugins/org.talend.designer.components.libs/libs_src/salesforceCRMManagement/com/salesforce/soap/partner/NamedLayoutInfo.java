...
/**
 * NamedLayoutInfo bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NamedLayoutInfo implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = NamedLayoutInfo Namespace URI = urn:partner.soap.sforce.com
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":NamedLayoutInfo",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "NamedLayoutInfo", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static NamedLayoutInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NamedLayoutInfo object = new NamedLayoutInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NamedLayoutInfo".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (NamedLayoutInfo) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
