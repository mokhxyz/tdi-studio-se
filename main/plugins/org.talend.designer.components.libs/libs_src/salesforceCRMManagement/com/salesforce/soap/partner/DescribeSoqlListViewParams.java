...
/**
 * DescribeSoqlListViewParams bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeSoqlListViewParams implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeSoqlListViewParams Namespace URI =
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeSoqlListViewParams", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeSoqlListViewParams",
                        xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeSoqlListViewParams parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeSoqlListViewParams object = new DescribeSoqlListViewParams();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeSoqlListViewParams".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeSoqlListViewParams) com.salesforce.soap.partner.sobject.ExtensionMapper
