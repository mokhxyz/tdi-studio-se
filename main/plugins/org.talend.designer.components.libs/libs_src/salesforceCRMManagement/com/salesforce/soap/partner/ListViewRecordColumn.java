...
/**
 * ListViewRecordColumn bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ListViewRecordColumn implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = ListViewRecordColumn Namespace URI = urn:partner.soap.sforce.com
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":ListViewRecordColumn", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ListViewRecordColumn", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static ListViewRecordColumn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ListViewRecordColumn object = new ListViewRecordColumn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ListViewRecordColumn".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ListViewRecordColumn) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
