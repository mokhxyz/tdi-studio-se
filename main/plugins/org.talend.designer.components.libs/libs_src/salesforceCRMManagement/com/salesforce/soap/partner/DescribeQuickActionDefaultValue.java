...
/**
 * DescribeQuickActionDefaultValue bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeQuickActionDefaultValue implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeQuickActionDefaultValue Namespace URI =
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeQuickActionDefaultValue", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeQuickActionDefaultValue",
                        xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(localDefaultValue == null ? null : org.apache.axis2.databinding.utils.ConverterUtil
                .convertToString(localDefaultValue));
    ...
    public static class Factory {
         ...
         */
        public static DescribeQuickActionDefaultValue parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeQuickActionDefaultValue object = new DescribeQuickActionDefaultValue();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeQuickActionDefaultValue".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeQuickActionDefaultValue) com.salesforce.soap.partner.sobject.ExtensionMapper
