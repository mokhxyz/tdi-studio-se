...
public class LoginResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    protected com.salesforce.soap.partner.LoginResult localResult;

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.LoginResult
     */
    public com.salesforce.soap.partner.LoginResult getResult() {
        return localResult;
    }
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.LoginResult param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":loginResponse",
                        xmlWriter);
            } else {
        ...
        public static LoginResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"loginResponse".equals(type)) {
                            ...
                            return (LoginResponse) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    object.setResult(com.salesforce.soap.partner.LoginResult.Factory.parse(reader));
