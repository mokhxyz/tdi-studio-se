...
public class SendEmailError implements org.apache.axis2.databinding.ADBBean {

    /*
     * This type was generated from the piece of schema that had name = SendEmailError Namespace URI =
    ...
    protected com.salesforce.soap.partner.ID localTargetObjectId;
     ...
     */
    public com.salesforce.soap.partner.ID getTargetObjectId() {
     ...
     */
    public void setTargetObjectId(com.salesforce.soap.partner.ID param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SendEmailError",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SendEmailError", xmlWriter);
            }
        ...
        if (localTargetObjectId == null) {
            ...
            writeStartElement(null, "urn:partner.soap.sforce.com", "targetObjectId", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "targetObjectId"));
    ...
    public static class Factory {
        ...
        public static SendEmailError parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SendEmailError object = new SendEmailError();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SendEmailError".equals(type)) {
                            ...
                            return (SendEmailError) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "targetObjectId")
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setTargetObjectId(com.salesforce.soap.partner.ID.Factory.parse(reader));
