...
public class SendEmailResult implements org.apache.axis2.databinding.ADBBean {

    /*
     * This type was generated from the piece of schema that had name = SendEmailResult Namespace URI =
    ...
    protected com.salesforce.soap.partner.SendEmailError[] localErrors;
     ...
     * 
     * @return com.salesforce.soap.partner.SendEmailError[]
     */
    public com.salesforce.soap.partner.SendEmailError[] getErrors() {
        return localErrors;
    }
     ...
     */
    protected void validateErrors(com.salesforce.soap.partner.SendEmailError[] param) {
     ...
     * @param param Errors
     */
    public void setErrors(com.salesforce.soap.partner.SendEmailError[] param) {
     ...
     * 
     * @param param com.salesforce.soap.partner.SendEmailError
     */
    public void addErrors(com.salesforce.soap.partner.SendEmailError param) {
        if (localErrors == null) {
            localErrors = new com.salesforce.soap.partner.SendEmailError[] {};
        }
        ...
        list.add(param);
        this.localErrors = (com.salesforce.soap.partner.SendEmailError[]) list
                .toArray(new com.salesforce.soap.partner.SendEmailError[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SendEmailResult",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SendEmailResult", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static SendEmailResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SendEmailResult object = new SendEmailResult();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SendEmailResult".equals(type)) {
                            ...
                            return (SendEmailResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    list1.add(com.salesforce.soap.partner.SendEmailError.Factory.parse(reader));
                    ...
                    object.setErrors((com.salesforce.soap.partner.SendEmailError[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.SendEmailError.class, list1));
