...
/**
 * DescribeCompactLayouts bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeCompactLayouts implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeCompactLayouts", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeCompactLayouts", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeCompactLayouts", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeCompactLayouts parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeCompactLayouts object = new DescribeCompactLayouts();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeCompactLayouts".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeCompactLayouts) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
