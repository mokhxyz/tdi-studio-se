...
/**
 * DescribeThemeItem bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeThemeItem implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeThemeItem Namespace URI = urn:partner.soap.sforce.com
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":DescribeThemeItem", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeThemeItem", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeThemeItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeThemeItem object = new DescribeThemeItem();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeThemeItem".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeThemeItem) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    // Process the array and step past its final element's end.
                    list2.add(com.salesforce.soap.partner.DescribeIcon.Factory.parse(reader));
                    ...
                    object.setIcons((com.salesforce.soap.partner.DescribeIcon[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.DescribeIcon.class, list2));
