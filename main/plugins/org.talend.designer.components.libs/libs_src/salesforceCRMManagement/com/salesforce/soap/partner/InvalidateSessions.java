...
public class InvalidateSessions implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "invalidateSessions", "ns1");

    /**
     * field for SessionIds This was an Array!
     */
    ...
    public void setSessionIds(java.lang.String[] param) {
        ...
        localSessionIdsTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":invalidateSessions", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "invalidateSessions", xmlWriter);
            }
                ...
                for (int i = 0; i < localSessionIds.length; i++) {
                    ...
                    if (localSessionIds[i] != null) {
                        ...
                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localSessionIds[i]));
        ...
        if (localSessionIdsTracker) {
            if (localSessionIds != null) {
                for (int i = 0; i < localSessionIds.length; i++) {
                    ...
                    if (localSessionIds[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "sessionIds"));
        ...
        public static InvalidateSessions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"invalidateSessions".equals(type)) {
                            ...
                            return (InvalidateSessions) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "sessionIds").equals(reader.getName())) {
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "sessionIds").equals(reader
                                    .getName())) {
                                list1.add(reader.getElementText());
