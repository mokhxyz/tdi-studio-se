...
public class DescribeLayoutSection implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for LayoutRows This was an Array!
     */
    ...
    public void addLayoutRows(com.salesforce.soap.partner.DescribeLayoutRow param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localLayoutRows);
        list.add(param);
        this.localLayoutRows = (com.salesforce.soap.partner.DescribeLayoutRow[]) list
                .toArray(new com.salesforce.soap.partner.DescribeLayoutRow[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeLayoutSection", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeLayoutSection", xmlWriter);
            }
        ...
        if (false) {
            ...
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localUseCollapsibleSection));
        }

        xmlWriter.writeEndElement();

        namespace = "urn:partner.soap.sforce.com";
        writeStartElement(null, namespace, "useHeading", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localLayoutRows != null) {
            for (int i = 0; i < localLayoutRows.length; i++) {
                ...
                if (localLayoutRows[i] != null) {
                    elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "layoutRows"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "rows"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "useHeading"));

        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUseHeading));
        ...
        public static DescribeLayoutSection parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.isStartElement()
                    ...
                    object.setColumns(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "layoutRows").equals(reader.getName())) {
                    ...
                    while (!loopDone3) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "layoutRows").equals(reader
                                    .getName())) {
                                list3.add(com.salesforce.soap.partner.DescribeLayoutRow.Factory.parse(reader));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "rows").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "rows" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setRows(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "useCollapsibleSection").equals(reader
                                .getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "useCollapsibleSection"
                                + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setUseCollapsibleSection(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "useHeading").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "useHeading" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setUseHeading(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
