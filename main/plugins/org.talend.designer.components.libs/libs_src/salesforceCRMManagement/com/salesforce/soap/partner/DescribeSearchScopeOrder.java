...
/**
 * DescribeSearchScopeOrder bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeSearchScopeOrder implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeSearchScopeOrder", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeSearchScopeOrder", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeSearchScopeOrder", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeSearchScopeOrder parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeSearchScopeOrder object = new DescribeSearchScopeOrder();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeSearchScopeOrder".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeSearchScopeOrder) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
