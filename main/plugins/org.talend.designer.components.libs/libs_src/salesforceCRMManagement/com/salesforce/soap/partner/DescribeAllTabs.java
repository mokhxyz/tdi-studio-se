...
/**
 * DescribeAllTabs bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeAllTabs implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":describeAllTabs",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeAllTabs", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeAllTabs parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeAllTabs object = new DescribeAllTabs();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeAllTabs".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeAllTabs) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
