...
public class DescribeLayoutItem implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for LayoutComponents This was an Array!
     */
    ...
    public boolean isLayoutComponentsSpecified() {
        return localLayoutComponentsTracker;
    }

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.DescribeLayoutComponent[]
     */
    public com.salesforce.soap.partner.DescribeLayoutComponent[] getLayoutComponents() {
     ...
     */
    protected void validateLayoutComponents(com.salesforce.soap.partner.DescribeLayoutComponent[] param) {
     ...
     */
    public void setLayoutComponents(com.salesforce.soap.partner.DescribeLayoutComponent[] param) {

        validateLayoutComponents(param);

        localLayoutComponentsTracker = param != null;
     ...
     * 
     * @param param com.salesforce.soap.partner.DescribeLayoutComponent
     */
    public void addLayoutComponents(com.salesforce.soap.partner.DescribeLayoutComponent param) {
        if (localLayoutComponents == null) {
            localLayoutComponents = new com.salesforce.soap.partner.DescribeLayoutComponent[] {};
        }

        // update the setting tracker
        localLayoutComponentsTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localLayoutComponents);
        list.add(param);
        this.localLayoutComponents = (com.salesforce.soap.partner.DescribeLayoutComponent[]) list
                .toArray(new com.salesforce.soap.partner.DescribeLayoutComponent[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeLayoutItem", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeLayoutItem", xmlWriter);
            }
            ...
            if (localLayoutComponents != null) {
                for (int i = 0; i < localLayoutComponents.length; i++) {
                    if (localLayoutComponents[i] != null) {
                        localLayoutComponents[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                "layoutComponents"), xmlWriter);
                    } else {
        ...
        namespace = "urn:partner.soap.sforce.com";
        writeStartElement(null, namespace, "placeholder", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localLayoutComponentsTracker) {
            if (localLayoutComponents != null) {
                for (int i = 0; i < localLayoutComponents.length; i++) {
                    ...
                    if (localLayoutComponents[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "layoutComponents"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "placeholder"));

        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPlaceholder));

        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "required"));
    ...
    public static class Factory {
        ...
        public static DescribeLayoutItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeLayoutItem".equals(type)) {
                            ...
                            return (DescribeLayoutItem) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "layoutComponents").equals(reader
                                .getName())) {
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "placeholder").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "placeholder" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setPlaceholder(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "required").equals(reader.getName())) {
                    ...
                    object.setRequired(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
