...
/**
 * DescribeKnowledgeSettings bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeKnowledgeSettings implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeKnowledgeSettings", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeKnowledgeSettings", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeKnowledgeSettings", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeKnowledgeSettings parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeKnowledgeSettings object = new DescribeKnowledgeSettings();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeKnowledgeSettings".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeKnowledgeSettings) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
