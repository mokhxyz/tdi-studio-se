...
/**
 * QuickActionTemplateResult bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class QuickActionTemplateResult implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = QuickActionTemplateResult Namespace URI =
     * urn:partner.soap.sforce.com Namespace Prefix = ns1
     */

    /**
     * field for DefaultValueFormulas
     */

    protected com.salesforce.soap.partner.sobject.SObject localDefaultValueFormulas;
     ...
     */
    public com.salesforce.soap.partner.sobject.SObject getDefaultValueFormulas() {
        return localDefaultValueFormulas;
    }

    /**
     * Auto generated setter method
     * 
     * @param param DefaultValueFormulas
     */
    public void setDefaultValueFormulas(com.salesforce.soap.partner.sobject.SObject param) {

        this.localDefaultValueFormulas = param;

    }

    /**
     * field for DefaultValues
     */

    protected com.salesforce.soap.partner.sobject.SObject localDefaultValues;
     ...
     * @return com.salesforce.soap.partner.sobject.SObject
     */
    public com.salesforce.soap.partner.sobject.SObject getDefaultValues() {
     ...
     */
    public void setDefaultValues(com.salesforce.soap.partner.sobject.SObject param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":QuickActionTemplateResult", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "QuickActionTemplateResult", xmlWriter);
            }

        }

        if (localDefaultValueFormulas == null) {

            writeStartElement(null, "urn:partner.soap.sforce.com", "defaultValueFormulas", xmlWriter);

            // write the nil attribute
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
            xmlWriter.writeEndElement();
        } else {
            localDefaultValueFormulas.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                    "defaultValueFormulas"), xmlWriter);
        }
        ...
        if (localDefaultValues == null) {
            ...
            localDefaultValues
                    .serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "defaultValues"), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "defaultValueFormulas"));

        elementList.add(localDefaultValueFormulas == null ? null : localDefaultValueFormulas);

        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "defaultValues"));

        elementList.add(localDefaultValues == null ? null : localDefaultValues);
        if (localErrorsTracker) {
            if (localErrors != null) {
                for (int i = 0; i < localErrors.length; i++) {
    ...
    public static class Factory {
         ...
         */
        public static QuickActionTemplateResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            QuickActionTemplateResult object = new QuickActionTemplateResult();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"QuickActionTemplateResult".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (QuickActionTemplateResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "defaultValueFormulas").equals(reader
                                .getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        object.setDefaultValueFormulas(null);
                        reader.next();
                        ...
                        object.setDefaultValueFormulas(com.salesforce.soap.partner.sobject.SObject.Factory.parse(reader));
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setDefaultValues(com.salesforce.soap.partner.sobject.SObject.Factory.parse(reader));
