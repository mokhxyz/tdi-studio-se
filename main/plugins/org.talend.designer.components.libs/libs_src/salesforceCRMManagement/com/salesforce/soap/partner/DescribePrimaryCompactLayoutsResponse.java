/**
 * DescribePrimaryCompactLayoutsResponse.java
 *
...
/**
 * DescribePrimaryCompactLayoutsResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribePrimaryCompactLayoutsResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describePrimaryCompactLayoutsResponse", "ns1");

    /**
     * field for Result This was an Array!
     */

    protected com.salesforce.soap.partner.DescribeCompactLayout[] localResult;
     ...
     */
    public com.salesforce.soap.partner.DescribeCompactLayout[] getResult() {
        return localResult;
    }
     ...
     */
    protected void validateResult(com.salesforce.soap.partner.DescribeCompactLayout[] param) {
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.DescribeCompactLayout[] param) {
     ...
     */
    public void addResult(com.salesforce.soap.partner.DescribeCompactLayout param) {
        if (localResult == null) {
            localResult = new com.salesforce.soap.partner.DescribeCompactLayout[] {};
        }
        ...
        list.add(param);
        this.localResult = (com.salesforce.soap.partner.DescribeCompactLayout[]) list
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describePrimaryCompactLayoutsResponse", xmlWriter);
            } else {
    ...
    public static class Factory {
         ...
         */
        public static DescribePrimaryCompactLayoutsResponse parse(javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            DescribePrimaryCompactLayoutsResponse object = new DescribePrimaryCompactLayoutsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describePrimaryCompactLayoutsResponse".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribePrimaryCompactLayoutsResponse) com.salesforce.soap.partner.sobject.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    object.setResult((com.salesforce.soap.partner.DescribeCompactLayout[]) org.apache.axis2.databinding.utils.ConverterUtil
