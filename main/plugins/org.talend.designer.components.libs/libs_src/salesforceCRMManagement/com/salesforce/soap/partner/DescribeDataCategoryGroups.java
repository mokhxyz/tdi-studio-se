...
/**
 * DescribeDataCategoryGroups bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeDataCategoryGroups implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeDataCategoryGroups", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeDataCategoryGroups", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeDataCategoryGroups",
                        xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeDataCategoryGroups parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeDataCategoryGroups object = new DescribeDataCategoryGroups();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeDataCategoryGroups".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeDataCategoryGroups) com.salesforce.soap.partner.sobject.ExtensionMapper
