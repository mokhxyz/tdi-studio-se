...
public class AttributeLabelProvider extends LabelProvider implements ITableLabelProvider {
     ...
     * 
     * @param attribute The MXBean attribute
    ...
    private Image getAttributeImage() {
        if (attributeImage == null || attributeImage.isDisposed()) {
            ...
            attributeImage = new OverlayImageDescriptor(imageData, new ImageDescriptor[0], new Point(IMAGE_WIDTH, IMAGE_HEIGHT))
                    .createImage();
        }
    ...
    private Image getAttributeFolderImage() {
        if (attributeFolderImage == null || attributeFolderImage.isDisposed()) {
            ImageData imageData = Activator.getImageDescriptor(ISharedImages.ATTRIBUTE_FOLDER_IMG_PATH).getImageData();
            attributeFolderImage = new OverlayImageDescriptor(imageData, new ImageDescriptor[0], new Point(IMAGE_WIDTH, 16))
                    .createImage();
        }
