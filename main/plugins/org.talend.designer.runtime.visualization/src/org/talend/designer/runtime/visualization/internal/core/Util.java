...
public class Util {
    ...
    public static void deleteDir(File dir) {
            ...
            for (File file : files) {
                if (file.isDirectory()) {
                    ...
                    if (!file.delete()) {
                        Activator.log(
                                IStatus.ERROR,
                                NLS.bind(org.talend.designer.runtime.visualization.Messages.removeFileFailedMsg,
                                        file.getAbsolutePath()), new Exception());
                    }
                }
            }
        }
        if (!dir.delete()) {
            Activator.log(IStatus.ERROR,
                    NLS.bind(org.talend.designer.runtime.visualization.Messages.removeDirectoryFailedMsg, dir.getAbsolutePath()),
                    new Exception());
        }
    }
    ...
    public static Properties loadProperties(IPath filePath) {
        ...
        try {
            ...
            Activator.log(IStatus.ERROR,
                    NLS.bind(org.talend.designer.runtime.visualization.Messages.openInputStreamFailedMsg, filePath.toOSString()),
                    e);
            return null;
        } catch (IOException e) {
            Activator.log(
                    IStatus.ERROR,
                    NLS.bind(org.talend.designer.runtime.visualization.Messages.loadPropertiesFileFailedMsg,
