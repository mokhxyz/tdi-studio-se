...
public class CallTreeNode extends AbstractMethodNode implements ICallTreeNode {
     ...
     */
    public CallTreeNode(ICpuModel cpuModel, String name, long time, int count, CallTreeNode parent, ThreadNode thread) {
     ...
     * @param thread the thread node
     */
    public CallTreeNode(ICpuModel cpuModel, String name, long time, int count, ThreadNode thread) {
     ...
     * 
     * @param time the self invocation time
     */
