...
public class MemorySection extends AbstractJvmPropertySection {
    ...
    protected void activateSection() {
        ...
        heapHistogramPage.updateLocalToolBar(tabFolder.getSelectionIndex() == 0);
    ...
    protected void updatePage() {
        ...
        if (jvm != null && jvm.isConnected()) {
            ...
            heapHistogramPageBook.showPage(heapHistogramMessageLabel.getText().isEmpty() ? heapHistogramPage
                    : heapHistogramMessageLabel);
        }
    }
    ...
    private void setMessageLabel(String message) {
        if (!heapHistogramMessageLabel.isDisposed() && !heapHistogramPageBook.isDisposed()) {
