 ...
 */
public class StopMonitoringAction extends Action implements ISelectionChangedListener {
    ...
    public StopMonitoringAction(TreeViewer treeViewer) {
        ...
        setImageDescriptor(Activator.getImageDescriptor(ISharedImages.DISCONNECT_IMG_PATH));
    }
