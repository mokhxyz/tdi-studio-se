...
public class CallTreeTabPage extends AbstractTabPage {
    ...
    public CallTreeTabPage(CpuSection cpuSection, CTabFolder tabFolder) {
        ...
        CTabItem tabItem = cpuSection.getWidgetFactory().createTabItem(tabFolder, SWT.NONE);
    ...
    protected void refresh() {
        if (!filteredTree.getViewer().getControl().isDisposed()) {
            ...
            filteredTree.updateStatusLine((IStructuredSelection) filteredTree.getViewer().getSelection());
        }
    ...
    private void refreshContentDescription() {
        ...
        if (focusedNode != null) {
            description.append(NLS.bind(Messages.focusTargetIndicator, focusedNode.getNonqualifiedName())).append(
                    NLS.bind(Messages.threadIndicator, focusedNode.getThread()));
        }
