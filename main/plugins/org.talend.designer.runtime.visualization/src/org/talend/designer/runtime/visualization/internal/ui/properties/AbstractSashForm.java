...
import org.talend.designer.runtime.visualization.internal.actions.ToggleOrientationAction.ISashForm;
import org.talend.designer.runtime.visualization.internal.actions.ToggleOrientationAction.Orientation;
...
public abstract class AbstractSashForm extends SashForm implements ISashForm {
     ...
     * @param sashWeights The sash weight
     */
     ...
     * @param actionBars The action bars
     */
    abstract protected void createSashFormControls(SashForm sashForm, IActionBars actionBars);
