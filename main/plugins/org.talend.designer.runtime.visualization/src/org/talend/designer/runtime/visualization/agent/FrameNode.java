...
import org.talend.designer.runtime.visualization.agent.asm.Type;
...
public class FrameNode {
     ...
     * The constructor.
     * 
     * @param parent The parent frame node
     ...
     * 
     * @param time The time stepping into this frame
     * @param overhead The overhead time
     */
     ...
     * 
     * @param time The time stepping return from this frame
     * @param overhead The overhead time
     */
    ...
    protected void dump(PrintWriter writer, long time, int nest) {
        ...
        writer.printf("<frame name=\"%s\" cnt=\"%d\" time=\"%d\"", name, count, Math.max(actualTotalTime, 0));
    ...
    protected void dump(StringBuffer buffer, long time, int nest) {
        ...
        buffer.append("<frame name=\"").append(name).append("\" cnt=\"").append(count).append("\" time=\"")
    ...
    private String getFrameName() {
        ...
        Type[] types = Type.getArgumentTypes(methodName.substring(methodName.indexOf('(')));
