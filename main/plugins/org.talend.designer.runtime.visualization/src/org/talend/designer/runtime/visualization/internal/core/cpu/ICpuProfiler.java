...
public interface ICpuProfiler {
     ...
     */
    void transformClasses(IProgressMonitor monitor) throws JvmCoreException, InterruptedException;
    ...
    /**
     * Refreshes the BCI profiling data cache in JVM model accessing to target JVM.
     * 
     * @param monitor The progress monitor
     * @throws JvmCoreException
     */
    void refreshBciProfileCache(IProgressMonitor monitor) throws JvmCoreException;
