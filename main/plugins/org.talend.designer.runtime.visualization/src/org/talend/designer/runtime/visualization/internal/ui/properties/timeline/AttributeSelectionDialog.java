...
public class AttributeSelectionDialog extends Dialog {
    ...
    protected void configureShell(Shell newShell) {
        ...
        PlatformUI.getWorkbench().getHelpSystem().setHelp(newShell, IHelpContextIds.ATTRIBUTE_SELECTION_DIALOG);
    }
    ...
    public static class MyFilteredTree extends FilteredTree {
        ...
        protected MyFilteredTree(Composite parent) {
            super(parent, SWT.MULTI | SWT.FULL_SELECTION | SWT.BORDER, new PatternFilter(), true);
    ...
    private static class MyDecoratingStyledCellLabelProvider extends DecoratingStyledCellLabelProvider implements ILabelProvider {
        ...
        public MyDecoratingStyledCellLabelProvider() {
            super(new AttributeLabelProvider(), PlatformUI.getWorkbench().getDecoratorManager().getLabelDecorator(), null);
        }
