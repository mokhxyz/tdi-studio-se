...
import org.talend.designer.runtime.visualization.core.dump.CpuDumpParser;
import org.talend.designer.runtime.visualization.internal.actions.CollapseAllAction.ICollapseTarget;
...
import org.talend.designer.runtime.visualization.internal.core.cpu.CpuModelFactory;
...
import org.talend.designer.runtime.visualization.internal.core.cpu.IMethodNode;
...
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.AbstractContentProvider;
...
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.CallTreeContentProvider;
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.CallTreeFilteredTree;
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.CallTreeLabelProvider;
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.HotSpotsFilteredTree;
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.HotSpotsLabelProvider;
 ...
 * The CPU dump editor.
 */
public class CpuDumpEditor extends AbstractDumpEditor implements ICollapseTarget, IFindTarget {
    ...
    private void createCallTreePage() {
        ...
        final CallTreeFilteredTree callTreeFilteredTree = new CallTreeFilteredTree(panel, getEditorSite().getActionBars());
        ...
        Job job = new Job(Messages.parseCpuDumpFileJobLabel) {
            ...
            protected IStatus run(IProgressMonitor monitor) {
                ...
                try {
                    ...
                    return new Status(IStatus.ERROR, Activator.PLUGIN_ID, "Could not load CPU dump file.", e); //$NON-NLS-1$
     ...
     * 
     * @return The active filtered tree, or <tt>null</tt> if not available (when selecting info tab)
     */
    ...
    private Image getCallTreeImage() {
        if (callTreeImage == null || callTreeImage.isDisposed()) {
            callTreeImage = Activator.getImageDescriptor(ISharedImages.CALL_TREE_IMG_PATH).createImage();
        }
    ...
    private Image getHotSpotsImage() {
        if (hotSpotsImage == null || hotSpotsImage.isDisposed()) {
            hotSpotsImage = Activator.getImageDescriptor(ISharedImages.HOT_SPOTS_IMG_PATH).createImage();
        }
