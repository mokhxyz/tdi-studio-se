...
public class AddPackageDialog extends AbstractElementListSelectionDialog {
     ...
     * @param filteringPackages The packages to be filtered out
     */
    ...
    private void createPackageControls(Composite parent) {
        ...
        enableTextButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                int color = enabled ? SWT.COLOR_WIDGET_BACKGROUND : SWT.COLOR_LIST_BACKGROUND;
                fFilteredList.getChildren()[0].setBackground(Display.getDefault().getSystemColor(color));
     ...
     * Adds the package.
     * 
     * @param packageElements The package elements into which package is added
     * @param element The element which contains package element to be added
