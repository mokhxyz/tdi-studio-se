...
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.actions.FocusOnAction;
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.actions.ShowCallersCalleesAction;

/**
 * The abstract filtered tree.
 */
abstract public class AbstractFilteredTree extends FilteredTree implements IConfigurableColumns, IPropertyChangeListener {
    ...
    protected AbstractFilteredTree(Composite parent, IActionBars actionBars) {
        super(parent, SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION | SWT.MULTI, new PatternFilter(), true);
