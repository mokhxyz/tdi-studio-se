...
/**
 * The heap dump handler that contributes to the extension point <tt>org.jvmmonitor.core.heapDumpHandler</tt>.
 */
public class HeapDumpHandler implements IHeapDumpHandler {
    ...
    public int getMaxClassesNumber() {
        return Activator.getDefault().getPreferenceStore().getInt(IConstants.MAX_CLASSES_NUMBER);
    }
