 ...
 * @generated
 */
public class AbstractmapSwitch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case AbstractmapPackage.MAPPER_TABLE: {
                MapperTable mapperTable = (MapperTable)theEObject;
                T result = caseMapperTable(mapperTable);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case AbstractmapPackage.MAPPER_TABLE_ENTITY: {
                MapperTableEntity mapperTableEntity = (MapperTableEntity)theEObject;
                T result = caseMapperTableEntity(mapperTableEntity);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
