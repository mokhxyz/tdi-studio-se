 ...
 * @generated
 */
public class GenericMetadataSwitch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case GenericMetadataPackage.GENERIC_CONNECTION: {
                GenericConnection genericConnection = (GenericConnection)theEObject;
                T result = caseGenericConnection(genericConnection);
                if (result == null) result = caseConnection(genericConnection);
                if (result == null) result = caseAbstractMetadataObject(genericConnection);
                if (result == null) result = caseDataProvider(genericConnection);
                if (result == null) result = caseDataManager(genericConnection);
                if (result == null) result = caseElement(genericConnection);
                if (result == null) result = caseDeployedComponent(genericConnection);
                if (result == null) result = casePackage(genericConnection);
                if (result == null) result = caseNamespace(genericConnection);
                if (result == null) result = caseModelElement(genericConnection);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case GenericMetadataPackage.GENERIC_CONNECTION_ITEM: {
                GenericConnectionItem genericConnectionItem = (GenericConnectionItem)theEObject;
                T result = caseGenericConnectionItem(genericConnectionItem);
                if (result == null) result = caseConnectionItem(genericConnectionItem);
                if (result == null) result = caseItem(genericConnectionItem);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Generic Connection</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Generic Connection</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseGenericConnection(GenericConnection object) {
        return null;
    }

    /**
     * Returns the result of interpreting the object as an instance of '<em>Generic Connection Item</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Generic Connection Item</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
